...
const MoveItemUp = (state, index) => arrayLenCheck(state, al => al > 1 && index < al, () => swapArrayItems(state, index - 1, index))
const MoveItemDown = (state, index) => arrayLenCheck(state, al => index < (al - 1), () => swapArrayItems(state, index, index + 1))
